            ...
            try
            {
               // using (PrincipalContext pc = new PrincipalContext(ContextType.Domain, "fatima-group.com"))
                using (PrincipalContext pc = new PrincipalContext(ContextType.Domain, "fatima-group.com"))
                {
                    ...
                    //Deployed date 24-7-2017, Awais
                    //Deployed date 27-12-2017, Ahsin(Issue in Leave Yearly Report)
                    //Deployed date 22-01-2018, Ahsin(Issue in Monthly reports for new year)
                    //Deployed date 30-01-2018, Ahsin(Issue in CPL Leave Quota Edit)
                    //Deployed date 01-03-2018, Ahsin(New report with negative overtime)
                    //Deployed date 04-03-2018, Ahsin(New system report for missing in/out FSML)
                    //Deployed date 07-03-2018, Ahsin(RWML U2 Sick Leave Issue)
                    //Deployed date 19-04-2018, Adnan(Employee Attendance View)
